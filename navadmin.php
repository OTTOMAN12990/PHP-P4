  ...
  <ul class="main-menu">
      ...
      <ul class="sub-menu">
        <li><a href="">Enkelvoudig</a>
          <ul>
            ...
            <li><a href="levenrancier.php" class="thrdlvl">Leveranciers wijz</a></li>
            <li><a href="shw-all-product.php" class="thrdlvl">Produkten</a></li>
            <li><a href="shw-all-purchase.php" class="thrdlvl">Aankopen</a></li>
            <li><a href="shw-all-purchase1.php" class="thrdlvl">Aankop del</a></li>
            <li><a href="landvw.php" class="thrdlvl">land del</a></li>
    ...
    <li class="main-item"><a href="#">Toevoegen</a>
      <ul>
        ...
        <li><a href="add-country02.php" class="scndlvl"> &nbsp; Land &nbsp; </a></li>
        <li><a href="adminbeheer.php" class="scndlvl">beheerder</a></li>
        
      </ul>
    </li>
     <li class="main-item"><a href="logout.php">logout</a></li>
  </ul>
</div>
<!-- </nav> -->